...
var Exporter = (function () {
  ...
  function estimateVideoExportCost(w, h, nFrames) {
    var frameBytes = w * h * BYTES_PER_PIXEL;
    return exportCost("Video export", frameBytes * 4 + nFrames * 96 * 1024, w + "x" + h + " / " + nFrames + " frames");
  }

  function estimateGifExportCost(w, h, nFrames) {
    var frameBytes = w * h * BYTES_PER_PIXEL;
    return exportCost("GIF export", frameBytes * (nFrames + 4), w + "x" + h + " / " + nFrames + " frames");
  }
