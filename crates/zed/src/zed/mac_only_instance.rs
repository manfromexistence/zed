...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Dx Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Dx Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Dx Editor Preview Instance Running",
        ReleaseChannel::Stable => "Dx Editor Stable Instance Running",
    }
}
