...
mod dx_catalog_provider_settings_mutation;
mod dx_forge_backup_executor;
mod dx_forge_backup_runner_gate;
mod dx_forge_restore_approval;
mod dx_forge_restore_executor;
mod dx_forge_restore_target_plan;
...
impl NativeAgent {
    pub fn new(
        ...
        cx.new(|cx| {
            ...
            dx_catalog_agent_bridge::preview_provider_settings_registration_if_enabled(cx);
