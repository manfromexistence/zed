...
use super::web_audits::web_audit_rows;
use super::{
    CHECK_RECEIPT_SCHEMA, DxCheckPanelAdapterPlan, DxCheckPanelNotice, DxCheckPanelQuickFix,
    DxCheckPanelSection, DxCheckPanelSnapshot, VIEW_MODEL_SCHEMA, ZED_PANEL_SCHEMA,
};
...
pub(super) fn bounded_string_from(value: Option<&Value>) -> Option<String> {
    bounded_panel_text(string_from(value)?)
}

pub(super) fn bounded_panel_text(value: &str) -> Option<String> {
...
pub(super) fn bool_from(value: Option<&Value>) -> Option<bool> {
...
pub(super) fn u16_from(value: Option<&Value>) -> Option<u16> {
    u64_from(value).and_then(|value| u16::try_from(value).ok())
}

pub(super) fn u32_from(value: Option<&Value>) -> Option<u32> {
    u64_from(value).and_then(|value| u32::try_from(value).ok())
}

pub(super) fn u64_from(value: Option<&Value>) -> Option<u64> {
