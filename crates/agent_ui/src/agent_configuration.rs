...
use crate::{
    ...
    dx_agent_bridge::{
        ...
        catalog_active_provider_label, catalog_detail_label, catalog_receipt_status_label,
...
impl AgentConfiguration {
    ...
    fn render_provider_configuration_section(
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                "LLM Providers",
                "Add at least one provider to use AI-powered features with Dx Agent.",
    ...
    fn render_context_servers_section(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                ...
                "All MCP servers connected directly or via a Dx extension.",
