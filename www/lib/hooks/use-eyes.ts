...
import { DEFAULT_EYE_STATE, type Animation } from "@/lib/eyes-types";
import { getAllAnimations, getAnimation, getAnimationsByTrigger, getAnimationByKey } from "@/lib/eyes-registry";
