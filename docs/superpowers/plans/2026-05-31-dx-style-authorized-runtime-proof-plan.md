# DX Style Authorized Runtime Proof Readiness

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:executing-plans or subagent-driven-development to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make source-write readiness check the exact `authorized runtime validation` proof name advertised by the DX Style editor write-bridge preflight.

**Architecture:** Runtime validation remains unrun and mutation remains disabled. Web Preview and native readiness should report a specific blocker when the source-owned bridge no longer advertises the authorized runtime validation proof.
...
- [x] Add a specific authorized-runtime-validation runtime-proof blocker in Web Preview readiness.
...
- [x] Guard the new blocker code in Web Preview and native source-only tests.
